...
routes['/travels'] = 'Users#travels'
routes['POST']['/register'] = 'Users#register'
routes['POST']['/login'] = 'Users#login'
routes['/travels/add'] = 'Users#travels_add'
routes['POST']['/add_trip/<user_id>'] = 'Users#add_trip'
routes['/travels/destination/<trips_id>'] = 'Users#show'
routes['/logout'] = 'Users#logout'
routes['/add_userstrips/<trips_id>'] = 'Users#add_userstrips'
"""
